...
import PropertyTypes from "@/app/(user)/units/_components/PropertyTypes";
import Amenities from "@/app/(user)/projects/_components/Amenities";
import PaymentPlans from "@/app/(user)/projects/_components/PaymentPlans";

const SpecificUnitPage = () => {
  const unit = {
    id: 1,
...
export default SpecificUnitPage;
